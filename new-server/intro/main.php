...
<section class="oc2-fun" id="oc2-fun">
	<div class="fun-container">
		...
		<ul class="fun-ul">        
			<li>
			<a href="https://ooc77.blog.me/221976491477" target="_blank">
				<div class="fun-img-box">
					<img src="http://img.ocean2you.co.kr/renew/review/review17.jpg" alt="이미지">
				</div>
				<div class="fun-txt-box">
					<div class="fun-txt-title">
						<h5><span class="span-title">고성 오션투유리조트</span><span class="span-review"> &nbsp;[리뷰보기]</span></h5>
					</div>
					<div class="txt-small txt-keyword">
						<p class="p-tit"><span>키워드</span></p>
						<p class="p-content"><span>해삼, 멍게잡이 체험</span></p>
					</div>
					<div class="txt-small txt-blogger">
						<p class="p-tit"><span>블로거</span></p>
						<p class="p-content"><span>Philosophia</span></p>
					</div>
				</div>
			</a>
			</li><li>
				<a href="https://blog.naver.com/ngrace_/221889058715" target="_blank">
					<div class="fun-img-box">
						<img src="http://img.ocean2you.co.kr/renew/review/review18.jpg" alt="이미지">
					</div>
					<div class="fun-txt-box">
						<div class="fun-txt-title">
							<h5><span class="span-title">강원도 고성군 속초 애견동반가능 숙소-오션투유리조트 (오션뷰, 고래뷰룸)</span><span class="span-review"> &nbsp;[리뷰보기]</span></h5>
						</div>
						<div class="txt-small txt-keyword">
							<p class="p-tit"><span>키워드</span></p>
							<p class="p-content"><span>객실서 고래뷰, 펫룸</span></p>
						</div>
						<div class="txt-small txt-blogger">
							<p class="p-tit"><span>블로거</span></p>
							<p class="p-content"><span>앤그레이스</span></p>
						</div>
					</div>
				</a>
			</li><li>
				<a href="https://ooc77.blog.me/221878320705" target="_blank">
					<div class="fun-img-box">
						<img src="http://img.ocean2you.co.kr/renew/review/review19.jpg" alt="이미지">
					</div>
					<div class="fun-txt-box">
						<div class="fun-txt-title">
							<h5><span class="span-title">고성 오션투유콘도</span><span class="span-review"> &nbsp;[리뷰보기]</span></h5>
						</div>
						<div class="txt-small txt-keyword">
							<p class="p-tit"><span>키워드</span></p>
							<p class="p-content"><span>시설리뷰, 모듬회, 물회</span></p>
						</div>
						<div class="txt-small txt-blogger">
							<p class="p-tit"><span>블로거</span></p>
							<p class="p-content"><span>Philosophia</span></p>
				...
				<a href="https://blog.naver.com/cullin/221806652688" target="_blank">
					<div class="fun-img-box">
						<img src="http://img.ocean2you.co.kr/renew/review/review20.jpg" alt="이미지">
					</div>
					<div class="fun-txt-box">
						<div class="fun-txt-title">
							<h5><span class="span-title">[속초여행] 오션뷰 오션투유에서 숙박하고 삼포해변 산책</span><span class="span-review"> &nbsp;[리뷰보기]</span></h5>
						</div>
						<div class="txt-small txt-keyword">
							<p class="p-tit"><span>키워드</span></p>
							<p class="p-content"><span>해안산책, 일출뷰</span></p>
						</div>
						<div class="txt-small txt-blogger">
							<p class="p-tit"><span>블로거</span></p>
							<p class="p-content"><span>엔젤쪈</span></p>
						</div>
					</div>
				</a>
			</li><li style="display: list-item;">
				<a href="https://blog.naver.com/soulmae8/222064924133" target="_blank">
					<div class="fun-img-box">
						<img src="http://img.ocean2you.co.kr/renew/review/review21.jpg" alt="이미지">
					</div>
					<div class="fun-txt-box">
						<div class="fun-txt-title">
							<h5><span class="span-title">고성에 가면 조개를 잡으세요! 뚜비두바뚜비두바</span><span class="span-review"> &nbsp;[리뷰보기]</span></h5>
						</div>
						<div class="txt-small txt-keyword">
							<p class="p-tit"><span>키워드</span></p>
							<p class="p-content"><span>조개캐기, 조개잡이 꿀팁</span></p>
						</div>
						<div class="txt-small txt-blogger">
							<p class="p-tit"><span>블로거</span></p>
							<p class="p-content"><span>감성쏠매</span></p>
						</div>
					</div>
				</a>
			</li><li style="display: list-item;">
